...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LightMart — Lighting & Electricals in Nepal" },
      {
        name: "description",
        content:
          "LightMart supplies premium lights, switches, fans, electric stoves, clocks and electrical fittings across Nepal.",
      },
      { name: "author", content: "LightMart" },
